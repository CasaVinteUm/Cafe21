...
ui_HomeConfigImage = lv_img_create(ui_home);
lv_img_set_src(ui_HomeConfigImage, &ui_img_configsmall_png);
lv_obj_set_width( ui_HomeConfigImage, LV_SIZE_CONTENT);  /// 48
lv_obj_set_height( ui_HomeConfigImage, LV_SIZE_CONTENT);   /// 48
lv_obj_set_x( ui_HomeConfigImage, -24 );
lv_obj_set_y( ui_HomeConfigImage, 16 );
lv_obj_set_align( ui_HomeConfigImage, LV_ALIGN_TOP_RIGHT );
lv_obj_add_flag( ui_HomeConfigImage, LV_OBJ_FLAG_ADV_HITTEST );   /// Flags
lv_obj_clear_flag( ui_HomeConfigImage, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

ui_cTitle = lv_obj_create(ui_home);
...
ui_homeSubTitle = lv_label_create(ui_cTitle);
...
ui_homeTitle = lv_label_create(ui_cTitle);
...
lv_obj_set_style_text_font(ui_homeTitle, &ui_font_LoraRegula64, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_homeButton = lv_btn_create(ui_home);
lv_obj_set_width( ui_homeButton, 204);
lv_obj_set_height( ui_homeButton, 48);
lv_obj_set_x( ui_homeButton, 0 );
lv_obj_set_y( ui_homeButton, 268 );
